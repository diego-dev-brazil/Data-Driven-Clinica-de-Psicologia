...
ALTER TABLE hacompanhamentos ADD CONSTRAINT pk_hacompanhamentos PRIMARY KEY ( haco_id );
...
ALTER TABLE hacompanhamentos_mensais ADD CONSTRAINT pk_hacompanhamentos_mensais PRIMARY KEY ( hmen_id );

CREATE TABLE hdiagnosticos (
    hdiag_id          NUMBER NOT NULL,
    hdiag_nome        VARCHAR2(255) NOT NULL,
    hdiag_dt_entrada  DATE
)
LOGGING;
...
ALTER TABLE hdiagnosticos ADD CONSTRAINT pk_hdiagnosticos PRIMARY KEY ( hdiag_id );
...
ALTER TABLE hmodalidades ADD CONSTRAINT pk_hmodalidades PRIMARY KEY ( hmod_id );
...
ALTER TABLE hmotivo_saidas ADD CONSTRAINT pk_hmotivo_saidas PRIMARY KEY ( hmot_id );
